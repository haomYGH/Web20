...
class Demo extends React.Component {
    ...
    constructor(props){
        ...
        this.state = {
            ...
            categories:null,//Map对象

            // handleMainImage,//方法从下面拿，state只初始化数据
			// handleImages,
            // handleDetail,
            
            mainImageValidateStatus:false,//默认不显示错误提示
            mainImageHelp:false,
    ...
    componentDidMount(){
        //父组件需要根据商品ID去异步回去商品详情，拿到后放入自己的state，
        //然后传给子组件，子组件拿到数据后，放入自己的state，然后通过value属性来展示默认值。
		//加载最新商品分类
                ...
                <Form {...layout} ref={this.formRef}>
                    ...
                    >
                        <RichEditor 
                            ...
                            values ={this.state.productId ? detail : '' }
                            isEdit={this.state.productId ? true : false }
                        />
                    </Form.Item>
